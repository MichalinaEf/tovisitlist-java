...
public class ToVisitListControl {
    ...
    private enum Option {
        ...
        PRINT_CITIES_ON_YOUR_TO_VISIT_LIST (4, " - to view cities on your ToVisitList and plan new journey :)"),
        PRINT_MONUMENTS_ON_YOUR_TO_VISIT_LIST (5, " - to view monuments on your ToVisitList and plan new journey :)"),
        PRINT_NATURAL_SPOTS_ON_YOUR_TO_VISIT_LIST (6, " - to view natural spots on your ToVisitList and plan new journey :)"),
        PRINT_TOVISITLIST(7, " - to view your ToVisitList");
