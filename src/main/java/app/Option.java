...
public enum Option {
    ...
    ADD_NEW_CITY (1," - to add new city to your ToVisitList"),
    ADD_NEW_MONUMENT (2," - to add new monument to your ToVisitList"),
    ADD_NEW_NATURAL_SPOT (3, " - to add new natural spot to your ToVisitList"),
